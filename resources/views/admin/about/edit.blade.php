        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('abouts.update', ['lang' => app()->getLocale(), 'about' => $about->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        @method('PUT')
                        @foreach (['en', 'ar'] as $lang)
                            <div class="form-group">
                                <label for="name_{{ $lang }}">{{ __('messages.name') }} ({{ strtoupper($lang) }}):</label>
                                <input type="text" class="form-control" name="name_{{ $lang }}" id="name_{{ $lang }}" value="{{ old('name_' . $lang, $about->{'name_' . $lang}) }}" >
                                @error('name_' . $lang)
                        ...
                        @endforeach
                            ...
                            <div id="drop-area" class="drop-area">
                                ...
                                @if ($about->image)
                                    <img id="image-preview" src="{{ asset($about->image) }}" alt="Image Preview" style="margin-top: 10px; max-width: 100%;">
                                @else
