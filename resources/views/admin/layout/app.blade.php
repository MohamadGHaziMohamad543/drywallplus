                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{ asset('user.png') }}" alt="Header Avatar">
                                <span class="d-none d-sm-inline-block ms-1">{{ Auth::user()->name }}
</span>
...
<div class="dropdown-menu dropdown-menu-end">
    ...
    <form action="{{ route('logout', ['lang' => app()->getLocale()]) }}" method="POST">
        @csrf
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('dashboard.admin', ['lang' => app()->getLocale()]) }}" class="waves-effect">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="{{ route('subcategories.index', ['lang' => app()->getLocale()]) }}">Sub Category</a></li>
                                    <li><a href="{{ route('subsubcategories.index', ['lang' => app()->getLocale()]) }}">Sub Sub Category</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="{{ route('contact-us.index', ['lang' => app()->getLocale()]) }}">Contact</a></li>
                                    <li><a href="{{ route('sliders.index', ['lang' => app()->getLocale()]) }}">slider</a></li>
                                </ul>
                            </li>
                        </ul>
